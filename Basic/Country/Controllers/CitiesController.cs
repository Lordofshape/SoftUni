...
namespace Country.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,CountryId")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,CountryId")] City city)
        {
            if (id != city.Id)
            {
                return NotFound();
